...
resource "aws_instance" "Apache" {
  ...
  ami               = lookup(var.Ubuntu_WebServer_AMI, var.Region)
  ...
  #
  yes fortinet123 | sudo passwd user
  #
  #      Install Apache  
  #
  sudo apt update -y
  ...
  #
  echo "<html><style>body { font-size: 15px;}</style><body><h1>Hello, Everyone &#128075</h1><h2>This is our first Apache Server created via Terraform &#128079 &#128170; </h2></body></html>" > /var/www/html/index.html
  #
